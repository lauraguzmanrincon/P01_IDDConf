# Getting help with P01_IDDConf

Thanks for using P01_IDDConf!
...
*   If it's a bug: you're in the right place, [file an issue](https://github.com/lauraguzmanrincon/P01_IDDConf/issues/new).  
  
*   If you're not sure: let the community help you figure it out! 
    If your problem _is_ a bug or a feature request, you can easily return here and report it. 

Before opening a new issue, be sure to [search issues and pull requests](https://github.com/lauraguzmanrincon/P01_IDDConf/issues) to make sure the bug hasn't been reported and/or already fixed in the development version. 
